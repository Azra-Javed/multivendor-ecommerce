...
//   return (
//     <div className="flex flex-col items-center w-full px-4 800px:px-10">
//       {/* Avatar */}
//       <div className="relative mb-6">
//         <img
//           src={avatar ? URL.createObjectURL(avatar) : user?.avatar?.url}
//           alt="Avatar"
//           className="w-[140px] h-[140px] rounded-full object-cover border-2 border-[#3ad132]"
//         />
//         <div className="w-8 h-8 bg-[#E3E9EE] rounded-full flex items-center justify-center cursor-pointer absolute bottom-2 right-2">
//           <input
//             type="file"
//             id="image"
//             className="hidden"
...
//         <div className="flex flex-col 800px:flex-row gap-4 mb-4">
...
//           <button
//             type="submit"
//             className="w-[220px] h-10 bg-white border border-[#3a24db] text-[#3a24db] font-medium rounded-md hover:bg-[#f0f0ff] transition"
//           >
//             Update
//           </button>
//         </div>
...
const UserProfile = () => {
  ...
  return (
    <div className="flex flex-col ml-5 p-3 pb-5 bg-white items-center w-full px-4 sm:px-6 md:px-10">
      {/* Avatar */}
      <div className="relative mb-6">
        <img
          src={avatar ? URL.createObjectURL(avatar) : user?.avatar?.url}
